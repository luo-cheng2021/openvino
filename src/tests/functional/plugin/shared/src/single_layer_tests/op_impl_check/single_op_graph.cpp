...
std::shared_ptr<ov::Model> generate(
    const std::shared_ptr<ov::op::v6::GenerateProposalsSingleImage> &node) {
    ...
    const auto attrs =
        ov::op::v6::GenerateProposalsSingleImage::Attributes{0, 0.699999988079071, 6, 1000};
    const auto exp_gen_prop_sing_img =
        std::make_shared<ov::op::v6::GenerateProposalsSingleImage>(im_info,
                                                                                        anchors,
                                                                                        deltas,
                                                                                        scores,
                                                                                        attrs);
