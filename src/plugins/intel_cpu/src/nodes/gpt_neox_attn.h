...
protected:
    ...
    void applyRotaryPosEmb_i8(uint8_t* q_src, uint8_t* k_src, uint8_t* q_dst, const std::vector<uint8_t*>& k_dst, size_t k_start,
                           float* cos_cached, float* sin_cached, size_t batch, size_t qSeqLen, size_t offset);
    void applyRotaryPosEmb_bf16(uint8_t* q_src, uint8_t* k_src, uint8_t* q_dst, const std::vector<uint8_t*>& k_dst, size_t k_start,
                           float* cos_cached, float* sin_cached, size_t batch, size_t qSeqLen, size_t offset);
