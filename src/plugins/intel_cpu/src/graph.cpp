...
public:
    explicit UpdateNodesSeq(std::vector<NodePtr>& executableGraphNodes, std::unordered_map<std::string, std::array<uint64_t, 5>>& countersMap) :
        m_executableGraphNodes(executableGraphNodes), m_countersMap(countersMap) {}
