...
op::internal::SelectInput::SelectInput(const Output<Node>& args0, const Output<Node>& args1, const Output<Node>& mask, const element::Type output_type)
    : Op({args0, args1, mask}),
    m_output_type(output_type) {
    constructor_validate_and_infer_types();
}

std::shared_ptr<Node> op::internal::SelectInput::clone_with_new_inputs(
