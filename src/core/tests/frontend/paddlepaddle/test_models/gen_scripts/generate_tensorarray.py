...
def test_conditional_block_slice0_dimensions():
    ...
    print(test('conditional_block_slice0_dimensions', [a]))
    a_shape = a.shape
    a_shape[0] = -1
    print(test('conditional_block_slice0_dimensions_dyn', [a], [a_shape]))
...
if __name__ == "__main__":
    ...
    test_conditional_block_slice0_dimensions()
