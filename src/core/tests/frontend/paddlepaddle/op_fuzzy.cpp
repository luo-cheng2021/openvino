...
static const std::vector<std::string> models{
    ...
    std::string("conditional_block/conditional_block.pdmodel"),
    std::string("conditional_block2/conditional_block2.pdmodel"),
    std::string("conditional_block_2outputs/conditional_block_2outputs.pdmodel"),
    std::string("conditional_block_dyn/conditional_block_dyn.pdmodel"),
