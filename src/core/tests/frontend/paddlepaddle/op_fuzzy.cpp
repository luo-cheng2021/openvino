...
static const std::vector<std::string> models{
    ...
    // std::string("conditional_block_slice0_axis2/conditional_block_slice0_axis2.pdmodel"),   // No such case in model, as paddle.concat always concat along axis 0.
    ...
    std::string("conditional_block_slice0_2tensorarrays_extra_dyn/conditional_block_slice0_2tensorarrays_extra_dyn.pdmodel"),    
    ...
    std::string("loop_tensor_array_concat1_slice1/loop_tensor_array_concat1_slice1.pdmodel"),
